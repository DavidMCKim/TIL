...
# append는 추가된 원소가 리스트면 하위 리스트로 추가됨 - 리스트안의 리스트
...
# 첫번째 요소부터 비교 시작
# 첫번째 요소의 비교에서 결과가 False 이면 더이상 비교 하지 않고 첫번째 요소가 동일하면 두번째 요소 비교..
