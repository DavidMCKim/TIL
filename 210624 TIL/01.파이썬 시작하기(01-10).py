...
# 002 화면에 Mary's cosmetics 을 출력하세요. (중간에 '가 있음에 주의하세요)
...
# 006 print 함수에 두 개의 단어를 입력한 예제입니다. 아래 코드의 출력 결과를 예상해 봅시다.
...
# naver/kako/sk/samsung
print("naver", "kakao", "sk", "samsung", sep='/')
print("---------------------------------")
print()

# 009 다음 코드를 수정하여 줄바꿈이 없이 출력하세요. (힌트 : end='') print함수는 두번 사용합니다.
